...
from ccp.training_config import Experiment
from ccp.register_env import register_custom_components
...
from ccp.register_training_utils import register_custom_model


class CCPInferenceConfig(AlgoBase, extra=Extra.forbid):
    """
    ...
    """
    name: Literal['CCP'] = 'CCP'

    path_to_weights: str = "model/ccp"
...
class CCPInference:
    ...
    def __init__(self, config):
        ...
        self.algo_cfg: CCPInferenceConfig = config
        ...
        # 最佳权重文件为 best
        name_prefix = dict(latest="checkpoint", best="best")[config.load_checkpoint_kind]
